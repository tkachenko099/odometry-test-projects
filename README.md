...
├── scripts/                 # build.sh, run_experiment.sh, run_all_experiments.sh, dashboard.sh, sim_dashboard.sh, reproduce_kfgins.sh
├── experiments/
...
### 8. Reproduce the KF-GINS reference (milestone 1)
